  ...
  const UNITS = [
    { order: 1, semester: 1, domain: 'self',
      ...
      sessions: [
        ...
        { id: S(9), title_ar: 'ما الذي يهمّني', title_en: 'What I Value' },
        { id: S(10), title_ar: 'مشاعري بالاسم', title_en: 'Naming My Feelings' },
        { id: S(11), title_ar: 'قصّتي', title_en: 'My Story' },
    ...
    { order: 3, semester: 1, domain: 'comm',
      ...
      sessions: [
        ...
        { id: S(16), title_ar: 'اسأل سؤالاً أفضل', title_en: 'Ask a Better Question' },
