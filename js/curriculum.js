...
(function () {
  ...
  const UNITS = [
    { order: 1, semester: 1, domain: 'self',
      ...
      sessions: [
        { id: S(1), title_ar: 'ماهي نقاط قوتي', title_en: 'Know Your Strength' },
        { id: S(9), title_ar: 'ماهي اهتماماتي', title_en: 'What I Value' },
        { id: S(10), title_ar: 'أكتشف مشاعري', title_en: 'Naming My Feelings' },
        { id: S(11), title_ar: 'مواقف مهمة في حياتي', title_en: 'My Story' },
        { id: S(12), title_ar: 'ميثاق المجموعة', title_en: 'Our Group Charter' },
      ] },
    { order: 2, semester: 1, domain: 'manage',
      ...
      sessions: [
        { id: S(2), title_ar: 'فكر قبل أن تختار', title_en: 'Pause, Then Choose' },
        { id: S(3), title_ar: 'ابدأ بما يمكن إنجازه', title_en: 'Start Small' },
        { id: S(13), title_ar: 'تجاهل المشتّتات', title_en: 'Focus in the Noise' },
        { id: S(14), title_ar: 'بناء العادات', title_en: 'A Small Habit That Lasts' },
        { id: S(15), title_ar: 'ماذا لو أخطأت', title_en: 'When I Slip' },
      ] },
    { order: 3, semester: 1, domain: 'comm',
      ...
      sessions: [
        { id: S(4), title_ar: 'الاستماع الفعال', title_en: 'Listen Like a Detective' },
    ...
    { order: 4, semester: 1, domain: 'rel',
      ...
      sessions: [
        { id: S(18), title_ar: 'التعاطف مع الآخرين', title_en: 'In Their Shoes' },
        { id: S(19), title_ar: 'وضع الحدود بلطف', title_en: 'A Kind Boundary' },
        { id: S(20), title_ar: 'بناء الثقة', title_en: 'Building Trust' },
        { id: S(21), title_ar: 'إدارة الخلاف', title_en: 'When We Clash' },
        { id: S(22), title_ar: 'إصلاح العلاقات', title_en: 'Repair It' },
      ] },
    { order: 5, semester: 2, domain: 'collab',
      name_ar: 'اعمل ضمن فريق', name_en: 'Work as a Team',
      outcome_ar: 'يتّفق مع فريقه على هدف واحد، ويؤدّي دوره، ويتناوب على القيادة، ويسمّي العقبة حين يتعثّر الفريق.',
      outcome_en: 'Agree one goal, hold your role, take turns leading, and name the obstacle when the team stalls.',
      sessions: [
        { id: S(7), title_ar: 'لكل دور وزنه', title_en: 'Every Role Counts' },
        { id: S(23), title_ar: 'الهدف المشترك', title_en: 'One Team Goal' },
        { id: S(24), title_ar: 'متى أقود ومتى أتبع', title_en: 'Lead, Then Follow' },
        { id: S(25), title_ar: 'تجاوز عقبات الفريق', title_en: 'When the Team Stalls' },
        { id: S(26), title_ar: 'مشروع الفريق', title_en: 'The Team Project' },
      ] },
